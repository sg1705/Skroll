 ...
 */
public class DefaultClassifierFactoryStrategyForClassify implements ClassifierFactoryStrategy {
    /**
     * Default implementation of getCLassifierIds return list of classifier ids.
     * @return
     */
    public static final Logger logger = LoggerFactory.getLogger(DefaultClassifierFactoryStrategyForClassify.class);
    ...
    public List<Integer> getClassifierIds(Document document)   {
        ...
        switch (docType) {
            case Category.TEN_K:
                return newArrayList(ClassifierFactory.TEN_K_TOC_CLASSIFIER_ID);
            case Category.TEN_Q:
                return newArrayList(ClassifierFactory.TEN_Q_TOC_CLASSIFIER_ID);
           case Category.INDENTURE:
                return newArrayList(ClassifierFactory.INDENTURE_DEF_CLASSIFIER_ID, ClassifierFactory.INDENTURE_TOC_CLASSIFIER_ID);
            case Category.S4:
                return newArrayList(ClassifierFactory.S4_TOC_CLASSIFIER_ID);
            default:
