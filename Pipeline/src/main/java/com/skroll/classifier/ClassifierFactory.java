...
public class ClassifierFactory {
    ...
    private static final double[] TOC_ANNOTATING_THRESHOLD= new double[]{0, .9, .9999999, 0.99999}; //disable level 2 annotation in the doc model.
    public static final List<Integer> LOWER_TOC_CATEGORY_IDS = new ArrayList<>(Arrays.asList(Category.NONE, Category.TOC_2));
    private static final double[] LOWER_TOC_ANNOTATING_THRESHOLD= new double[]{2, .9}; //disable level 2 annotation in the doc model.
