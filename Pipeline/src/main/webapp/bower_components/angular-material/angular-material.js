...
var ITEM_HEIGHT  = 41,
    // start hack
    //commented this line below and replace with new value
...
function MdAutocompleteCtrl ($scope, $element, $mdUtil, $mdConstant, $mdTheming, $window,
  ...
  function updateScroll () {
    ...
    var paragraphId = ctrl.matches[ctrl.index].paragraphId;
    ...
    //end hack
      ...
      function getInputElement () {
        if (attr.mdFloatingLabel) {
          ...
          return '\
            <md-input-container md-theme="default-dark" md-no-float style="padding-bottom: 12px">\
