(function() {
  ...
  /* @ngInject */
  function ContentCtrl(documentModel, documentService, $mdSidenav, $location, searchFactory, $scope, $routeParams, relatedParaFactory, featureFlags) {
