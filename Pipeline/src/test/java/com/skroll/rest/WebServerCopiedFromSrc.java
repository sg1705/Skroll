 ...
 * For using the WebServerCopiedFromSrc, edit Run Configuration and in working directory setting
 * append "Pipeline" towards the end.
 */

public class WebServerCopiedFromSrc {
    ...
    public static void main(String[] args) throws Exception {
        ...
        WebServerCopiedFromSrc main = new WebServerCopiedFromSrc(port);
        main.start();
        main.waitForInterrupt();
    }

    private static final Logger LOG = Logger.getLogger(WebServerCopiedFromSrc.class.getName());
    ...
    public WebServerCopiedFromSrc(int port) {
        this.port = port;
    }
